...
import { Web3Icon } from '../app/components/icons/Web3Icon';
...
const BenefitCard: React.FC<BenefitCardProps> = ({ icon, title, description }) => (
  <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-xl transition-all duration-300 hover:bg-white/10 hover:-translate-y-2 shadow-lg">
    ...
    <p className="text-gray-300 leading-relaxed font-inter">{description}</p>
  </div>
);
    ...
    <section id="benefits" className="py-20 sm:py-28">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-400 font-inter">Security, Simplicity, and Peace of Mind in the Web3 world.</p>
        </div>
