        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden sm:flex items-center gap-4 text-xs">
              ...
              <a href="https://github.com/opsvantagedigi/my-smart-wallets-app" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">GitHub</a>
              <a href="https://x.com/opsvantagedigi" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">Twitter</a>
              <a href="https://www.linkedin.com/company/opsvantage-digital/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">LinkedIn</a>
            </nav>
          </div>
        </div>
      </div>
