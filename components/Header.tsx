      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:items-center md:space-x-8" aria-label="Main Navigation">
            <Link href="/" className="text-gray-200 hover:text-white font-inter font-medium transition">Home</Link>
            <Link href="/contact" className="text-gray-200 hover:text-white font-inter font-medium transition">Contact Us</Link>
          </nav>
